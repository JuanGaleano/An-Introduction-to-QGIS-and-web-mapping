...
Let's check if we all have the **HEATMAP** 
...
2) Create a subset of the original data using a condition: Keep only violent crimes ("robbery", "aggravated assault", "rape", "murder") and restrict data to downtown. 
  Copy and paste this condition on the dialogue box: (offense != 'auto theft'  AND  offense  !=  'theft'  AND  offense != 'burglary')  AND (lon  >=  -95.39681  AND  lon <= -95.34188  AND   lat  >=  29.73631  AND  lat <= 29.78400)
